...
public class DKImageLocalizedString {
    ...
    public class func localizedStringForKey(key: String, value: String) -> String {
        return NSLocalizedString(key, tableName: "DKImagePickerController", bundle:NSBundle.imagePickerControllerBundle(), value: value, comment: "")
    }
...
public func DKImageLocalizedStringWithKey(key: String, value: String) -> String {
