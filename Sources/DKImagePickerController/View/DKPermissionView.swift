...
open class DKPermissionView: UIView {
	...
	open class func permissionView(_ style: DKImagePickerControllerSourceType, withColors colors: DKPermissionViewColors = DKPermissionViewColors()) -> DKPermissionView {
